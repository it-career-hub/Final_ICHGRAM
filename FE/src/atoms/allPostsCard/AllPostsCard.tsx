...
const AllPostsCard: React.FC<AllPostsCardProps> = ({ image_url, caption, likes_count, comments_count, user_name, profile_image, created_at }) => {
  return (
    <div className="post-card">
      <div className="post-card-header">
        <img src={profile_image} alt={`${user_name} profile`} className="profile-image" />
        <span>{user_name}</span>
      </div>
